...
var assert assertions //nolint:gochecknoglobals

func (assertions) NoError(t testing.TB, err error) {
	t.Helper()
	if err != nil {
...
func (assertions) Equal(t testing.TB, want, got any) {
	t.Helper()
...
func (assertions) ErrorIs(t testing.TB, err, target error) {
	t.Helper()
